        ...
        <div class="h-screen w-screen flex flex-col">
            ...
            <div class="flex flex-row">
                ...
                <div class="pt-7  w-screen ml-[50px] flex flex-col">
                    ...
                    <!--Overlay/Event-->
                    <div class="absolute w-[17325px] h-[965px] right-0 top-[145px] opacity-50 bg-blue-hover"> </div>
                    <img class="w-[400px] h-[450px] top-[270px] left-[730px] absolute"
                        src="/images/Rectangle 4355.png" />
                    <button class= "" onclick="window.location.href='{{ url('event1') }}'">
                        <img class="w-[33px] h-[33px] absolute top-[285px] left-[780px]"
                            src="/images/Close_square.png" />
                    </button>
                    <span class="text-blue text-[23px] font-bold font-['Inter'] absolute top-[285px] left-[760px] ">
                        Christmas Party 2023
                    </span>
                    <img class="w-[398px] h-[200px] top-[335px] left-[730px] absolute" src="/images/Image Rec.png" />
                    <span
                        class="text-blue-hover w-[370px] text-[10px]  font-['Inter'] absolute top-[560px] left-[750px] ">
                        Lorem ipsum dolor sit amet, consectetur adipiscin g elit, sed
                    ...
                    <span
                        class="text-blue-hover w-[370px] text-[10px] font-bold font-['Inter'] absolute top-[640px] left-[750px] whitespace-pre-line ">
                        Location:
                        Date and Time:
                        Register:
                    </span>
                        ...
                        <div class="absolute justify-center flex flex-col items-center inline-flex">
                            ...
                            <div class="mt-[1rem] ml-[35rem] flex flex-row justify-center ">
                                <button
                                    ...
                                    <a href="#" href="#"
                                        onclick="window.location.href='{{ url('news2') }}'"
