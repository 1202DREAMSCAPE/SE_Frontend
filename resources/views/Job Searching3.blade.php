...
<body>
    ...
    <body class="bg-white-10 flex flex-col flex-nowrap">
        ...
        <img class="absolute w-[50px] h-[50px] ml-[32rem] top-[29rem]" src="/images/Rectangle 4363.png" />
        <span class="text-blue text-[24px] font-bold font-['Inter'] absolute top-[29rem] left-[41rem]">Company
            Name</span>
        <span class="text-black-200 text-[15px] font-medium font-['Inter'] absolute top-[3.800rem] left-[6rem] ">Manila
            City</span>
        <span class="text-blue text-[30px] font-extrabold font-['Inter'] absolute top-[8rem] left-[1rem]">Cybersecurity
            Analyst</span>
        <span class="text-black-200 text-[20px] font-medium font-['Inter'] absolute top-[11rem] left-[1rem] ">P120,000
            - P200,000</span>
        <span class="text-black-200 text-[20px] font-normal font-['Inter'] absolute top-[15rem] left-[1rem] ">Job
            Description</span>
        <button
            class="text-blue-pressed text-[18px] font-medium font-['Inter'] absolute top-[17rem] left-[32rem] ">Apply</button>
