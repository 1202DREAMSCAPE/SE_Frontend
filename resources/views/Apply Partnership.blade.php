...
<body>
    ...
    <body class="bg-white-10 flex flex-col flex-nowrap">
        ...
        <div class="h-screen w-screen flex flex-col">
            ...
            <!--BOOK AN EVENT-->
            <div class="flex flex-row">
                <img class= " w-[500px] h-[962px]" src="/images/Image w overlay blue.png">
                <div class="pt-7 w-screen text-center flex flex-col">
                    <span class="mt-2 text-[60px] font-inter font-bold text-blue ">
                        BE OUR PARTNER
                    </span>
                    <span
                        class="text-[17px] w-[700px] h-[63px] ml-[10rem] mt-1 font-inter font-light opacity-60 text-blue-hover whitespace-pre-line ">
                        Explore boundless possibilities for innovation and talent collaboration by
                        joining forces with our esteemed university, cultivating a dynamic partnership.
                    </span>
                    ...
                    <div class="mx-[8.2rem] mt-[2rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue"
                        x-data="{ name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text"
                            x-model="name" placeholder="Company Name *">
                    </div>
                    ...
                    <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue"
                        x-data="{ name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text"
                            x-model="name" placeholder="Company Email Address *">
                    </div>
                    ...
                    <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue"
                        x-data="{ name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text"
                            x-model="name" placeholder="Company Address *">
                    ...
                    <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue"
                        x-data="{ name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text"
                            x-model="name" placeholder="Primary Contact Person *">
                    </div>
                    ...
                    <div class="mx-[8.2rem] mt-[1.5rem] flex flex-row justify-self-center">
                        <div class="mr-[2rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue"
                            x-data="{ name: '' }">
                            <input class="font-inter text-center px-[4rem] focus:outline-none" type="text"
                                x-model="name" placeholder="Start Date *">

                        </div>
                        <div class="h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{ name: '' }">
                            <input class="font-inter text-center px-[4rem] focus:outline-none" type="text"
                                x-model="name" placeholder="End Date *">
                    ...
                    <div class="w-full py-35 mt-4 flex justify-center">
                        <button
                            class="font-inter text-center text-10 whitespace-nowrap text-white-10 py-4 my-5 px-14 bg-blue rounded-[1rem] border-[1px] border-blue">
