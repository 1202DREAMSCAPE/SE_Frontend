...
<body>
    ...
    <body class="bg-white-10 flex flex-col flex-nowrap">
        ...
        <div class="h-screen w-screen flex flex-col">
            ...
            <span class="absolute pt-8 ml-[32rem] text-center font-inter font-bold text-[64px] text-white-20">EVENT
                TITLE</span>
            <span
                class="absolute pt-20 pl-[35rem] text-center font-inter font-medium text-[30px] text-white-20 whitespace-pre-line">
                25 December 2023
                Location
                <span
                    class ="absolute text-center font-inter font-medium text-[20px] text-white-20 whitespace-pre-line flex">
                ...
                <div class=" flex flex-nowrap md:-m-2">
                    ...
                    <div class="flex w-1/3 flex-wrap">
                        <div class="w-full p-1 md:p-2">
                            <img class="w-[313px] h-[313px]  object-cover object-center"
                                src="/images/Rectangle 4355.png" />
                            <img class="w-[304px] h-[313px] top-[47px] object-cover object-center absolute "
